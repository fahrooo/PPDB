...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview">
                <a href="#">
                    <i class="fa fa-road"></i> <span>Daftar Jalur</span>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="#"><i class="fa fa-circle-o"></i> Perpindahan Orang Tua</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> Nilai Rapor</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> Afirmasi</a></li>
                    <li><a href="#"><i class="fa fa-circle-o"></i> Zonasi</a></li>
                </ul>
            </li>
            <!-- <li class="treeview">
                <a href="#">
